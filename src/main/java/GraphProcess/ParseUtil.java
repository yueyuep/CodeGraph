...
public class ParseUtil {
    ...
    private List<MethodDeclaration> mMethodDeclarations;
    private MethodDeclaration mMethodDeclaration;
    private List<SimpleName> mSimpleNamesOfClass;
    private ArrayList<VariableDeclarator> mFieldVariableDeclarators = new ArrayList<>();
    private ArrayList<SimpleName> mVariableDeclSimpleNames = new ArrayList<>();

    ParseUtil(String srcFilePath) throws FileNotFoundException {
