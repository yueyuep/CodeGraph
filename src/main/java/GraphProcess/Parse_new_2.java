...
public class Parse_new_2 {
    ...
    private Parse_new_2(String srcFile) throws FileNotFoundException {
...
//        }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Parse_new_2 p = new Parse_new_2(srcfilename);
        System.out.println("GraphProcess.Parse: " + p.srcfilename);

        // 示例：得到 某行 所有的方法调用，存储到节点列表methodCallExprsOfline，打印输出
        int want_line = 49;
        ArrayList<MethodCallExpr> methodCallExprsOfline = p.getMethodCallOfline(109);
        ...
        System.out.println("\n=============================================");
        System.out.println(methodCall_name + " in " + methodCall_line);
...
//             对提取到的所有代码行（节点列表final_nodes_want），进行变量名重命名
        p.renameVariableFieldNames(final_nodes_want);
