...
import CCPPView.treeview.JTreeTable;
import CCPPView.treeview.ast.ASTTreeModel;
...
public class ASTViewer{
    ...
    public ASTViewer() throws CoreException {
        ...
        fileChooser.setCurrentDirectory(new File("./cf"));
        ...
        GPPLanguage.getDefault().getKeywords();
