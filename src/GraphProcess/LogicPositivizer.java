package GraphProcess;//package com.yourorganization.maven_sample;
...
public class LogicPositivizer {
    public static void main(String[] args) throws IOException {
        ...
        CompilationUnit cu = sourceRoot.parse("", "data/Blabla.java");
        ...
        sourceRoot.saveAll(
                // The path of the Maven module/project which contains the GraphProcess.LogicPositivizer class.
